    ...
    <tr><td bgcolor="#f5f0e1" class="pad" style="padding:36px 44px 0 44px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr>
        ...
        <td valign="top" align="right" width="72" style="width:72px;">
          <img src="https://hepalumni.muoncollider.us/logos/mail/usmcc-mark-halo.png" width="72" height="72" alt="" style="display:block; width:72px; height:72px; border:0; outline:none;">
        </td>
      </tr></table>
    </td></tr>
